...
const CACHE = "sangju-v63";   // v63: 갈래 이름 통일(「정책 제안」→「정책제안」) + 개선사항 기록 정정 — index.html/proposals.js/version.js 동시 변경
// v62: 제안 수정 «진입 전» PIN 확인(verify_proposal_pin) — proposals.js·app.js 동시 변경
